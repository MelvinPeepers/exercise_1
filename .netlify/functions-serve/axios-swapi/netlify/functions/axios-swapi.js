...
// netlify/functions/axios-swapi.mjs
var axios_swapi_exports = {};
__export(axios_swapi_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(axios_swapi_exports);
...
async function handler() {
  ...
  try {
    ...
    const response = await axios_default.get(API_ENDPOINT);
...
mime-types/index.js:
   ...
   *)
*/
//# sourceMappingURL=axios-swapi.js.map
