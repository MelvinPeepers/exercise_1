...
// netlify/functions/fetch-swapi.mjs
var fetch_swapi_exports = {};
__export(fetch_swapi_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(fetch_swapi_exports);
...
async function handler(event, context) {
  ...
  try {
    ...
    return {
      ...
      body: name
      // Response body contains the planet name
    };
  } catch (err) {
    return {
      statusCode: 500,
...
*/
//# sourceMappingURL=fetch-swapi.js.map
